  ...
  <div class="container-top">
    <nav class="navbar">
        <ul class="nav navbar-nav navbar-right">
          ...
          <li><a href="<?php echo base_url('dosen/profil');?>"><span class="glyphicon glyphicon-user"></span>Dosen</a></li>
          <li><a href="<?php echo base_url('dosen/ganti_password');?>"><span class="glyphicon glyphicon-cog"></span>Change Password</a></li>
